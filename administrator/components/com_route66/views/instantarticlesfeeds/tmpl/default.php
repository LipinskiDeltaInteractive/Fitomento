...
<form action="<?php echo JRoute::_('index.php?option=com_route66&view=instantarticlesfeeds'); ?>" method="post" name="adminForm" id="adminForm">
	...
	<div id="j-main-container" class="span10">
		...
		<table class="table<?php if(version_compare(JVERSION, '4', '<')): ?> table-striped<?php endif; ?>" id="instantArticlesFeedsList">
				<thead>
						<tr>
				...
				<?php foreach ($this->items as $i => $item): ?>
						<tr class="row<?php echo $i % 2; ?>">
								...
								<td class="center text-center">
										<?php echo JHtml::_('jgrid.published', $item->state, $i, 'instantarticlesfeeds.', true, 'cb'); ?>
								</td>
								<td>
